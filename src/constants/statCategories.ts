...
export const COMMON_MLB_STATS: Record<number, StatMeta> = {
  ...
  9:  { id: 9,  name: 'Singles',           display: '1B',   positions: ['B'], sortOrder: '1' },
  10: { id: 10, name: 'Doubles',           display: '2B',   positions: ['B'], sortOrder: '1' },
  11: { id: 11, name: 'Triples',           display: '3B',   positions: ['B'], sortOrder: '1' },
  ...
  20: { id: 20, name: 'Hit By Pitch',      display: 'HBP',  positions: ['B'], sortOrder: '1' },
  ...
  33: { id: 33, name: 'Outs',              display: 'OUT',  positions: ['P'], sortOrder: '1' },
  34: { id: 34, name: 'Hits Allowed',      display: 'HA',   positions: ['P'], sortOrder: '0' },
  37: { id: 37, name: 'Earned Runs',       display: 'ER',   positions: ['P'], sortOrder: '0' },
  39: { id: 39, name: 'Walks Issued',      display: 'BB',   positions: ['P'], sortOrder: '0' },
  41: { id: 41, name: 'Hit Batters',       display: 'HBP',  positions: ['P'], sortOrder: '0' },
