...
const PARKS_RAW: Omit<ParkData, 'tendency'>[] = [
  // AL East
  {
    ...
    parkFactor: 105, parkFactorHR: 89, parkFactorL: 108, parkFactorR: 102,
    notes: 'Green Monster boosts doubles — strong LHB environment; suppresses HR slightly',
  },
  {
    mlbVenueId: 3313,
    name: 'Yankee Stadium',
    ...
    surface: 'grass', roof: 'open',
    parkFactor: 100, parkFactorHR: 119, parkFactorL: 101, parkFactorR: 99,
    notes: 'Short RF porch inflates HR dramatically (119 HR index) even though wOBA plays neutral',
  },
  {
    mlbVenueId: 14,
    name: 'Rogers Centre',
  ...
  },
  {
    ...
    surface: 'grass', roof: 'open',
    parkFactor: 100, parkFactorHR: 106, parkFactorL: 103, parkFactorR: 98,
    notes: 'Slight LHB lean; RF reachable for lefties; RHB suppressed after LF wall moved back',
  },
  {
    mlbVenueId: 12,
  ...
  },
  {
    ...
    surface: 'grass', roof: 'open',
    parkFactor: 102, parkFactorHR: 100, parkFactorL: 102, parkFactorR: 102,
    notes: 'A\'s temporary home since 2025; plays above-average for offense but ~neutral for HR',
  },
  {
    mlbVenueId: 680,
    name: 'T-Mobile Park',
    ...
    parkFactor: 91, parkFactorHR: 93, parkFactorL: 93, parkFactorR: 90,
    notes: 'One of the toughest parks in baseball; marine air crushes RHB especially (90 RHB index)',
  },
  {
    mlbVenueId: 5325,
  ...
  },
  {
    ...
    surface: 'grass', roof: 'open',
    parkFactor: 99, parkFactorHR: 76, parkFactorL: 100, parkFactorR: 98,
    notes: 'HR-suppressing environment (76 HR index — lowest in MLB); deep RF strongly suppresses LHB power',
  },
  {
    mlbVenueId: 2889,
    name: 'Busch Stadium',
  ...
  },
  {
    ...
    surface: 'grass', roof: 'open',
    parkFactor: 113, parkFactorHR: 105, parkFactorL: 113, parkFactorR: 112,
    notes: '5,200 ft elevation — ball carries dramatically; most extreme offensive environment in baseball',
  },
  {
    mlbVenueId: 22,
    name: 'Dodger Stadium',
    ...
    surface: 'grass', roof: 'open',
    parkFactor: 101, parkFactorHR: 127, parkFactorL: 99, parkFactorR: 103,
    notes: 'Massive HR inflation (127 HR index — highest in MLB); RHB strongly boosted',
  },
  {
    mlbVenueId: 2680,
    name: 'Petco Park',
