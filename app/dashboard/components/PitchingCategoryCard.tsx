...
export default function PitchingCategoryCard({ categories, onViewAllClick, showViewAllLink = true, loading = false }: { categories: CategoryStat[], onViewAllClick?: () => void, showViewAllLink?: boolean, loading?: boolean }) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 flex flex-col h-full">
      <div className="flex items-center gap-2 mb-4">
        <HiOutlineLightningBolt className="h-6 w-6 text-yellow-500" />
        <h2 className="text-lg font-semibold text-gray-700">Pitching</h2>
      </div>
